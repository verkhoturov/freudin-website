...
недоступен» (шаги 9–10). Настройки — пока заглушка (шаг 15): отредактировать профиль после
онбординга нельзя. Пример личной страницы — демо-профиль по адресу `/demo`.
...
├─ widgets/            # header, footer, sign-in-panel, profile-card, profile-form
